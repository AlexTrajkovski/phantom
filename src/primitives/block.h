...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // phantom
        hashUTXORoot.SetNull(); // phantom
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //phantom
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //phantom
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //phantom
    {
